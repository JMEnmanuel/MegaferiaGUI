...
public class MegaferiaFrame extends javax.swing.JFrame {
   ...
   /**
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try{
        long id = Long.parseLong(this.jTextField2.getText().trim());
        double price = Double.parseDouble(this.jTextField1.getText().trim());
        
        StandController controller = new StandController();
        Response<Stand> response = controller.crearStand(id, price);
       ...
       if (response.getStatusCode() == StatusCode.OK) {
            ...
            // Actualizar ComboBox
            this.jComboBox7.addItem(String.valueOf(id));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
     try {
        long id = Long.parseLong(this.jTextField3.getText().trim());
        String firstname = this.jTextField4.getText().trim();
        String lastname = this.jTextField5.getText().trim();
        
        PersonController controller = new PersonController();
        Response<Author> response = controller.crearAuthor(id, firstname, lastname);
        ...
        if (response.getStatusCode() == StatusCode.OK) {
            ...
            this.jComboBox3.addItem(id + " - " + firstname + " " + lastname);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
      ...
      try {
        ...
        PersonController controller = new PersonController();
        Response<Manager> response = controller.crearManager(id, firstname, lastname);
        ...
        if (response.getStatusCode() == StatusCode.OK) {
            ...
            this.jComboBox1.addItem(id + " - " + firstname + " " + lastname);
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
     ...
     try {
        ...
        PersonController controller = new PersonController();
        Response<Narrator> response = controller.crearNarrator(id, firstname, lastname);
        ...
        if (response.getStatusCode() == StatusCode.OK) {
            ...
            this.jComboBox6.addItem(id + " - " + firstname + " " + lastname);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
     try {
        String nit = this.jTextField6.getText().trim();
        String name = this.jTextField7.getText().trim();
        String address = this.jTextField8.getText().trim();
        
        String managerStr = (String) this.jComboBox1.getSelectedItem();
        if (managerStr == null || managerStr.equals("Seleccione uno...")) {
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Debe seleccionar un gerente", 
                "Error", 
                javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        long managerId = Long.parseLong(managerStr.split(" - ")[0]);
        
        PublisherController controller = new PublisherController();
        Response<Publisher> response = controller.crearPublisher(nit, name, address, managerId);
        ...
        if (response.getStatusCode() == StatusCode.OK) {
            ...
            String publisherInfo = name + " (" + nit + ")";
            this.jComboBox5.addItem(publisherInfo);
            this.jComboBox8.addItem(publisherInfo);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
          String authorStr = (String) this.jComboBox3.getSelectedItem();
    
    if (authorStr == null || authorStr.equals("Seleccione uno...")) {
        javax.swing.JOptionPane.showMessageDialog(this, 
    ...
    String currentText = this.jTextArea2.getText();
    if (!currentText.contains(authorStr)) {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Este autor no está en la lista", 
            "Advertencia", 
            javax.swing.JOptionPane.WARNING_MESSAGE);
        return;
    }
    
    // Eliminar del TextArea línea por línea
    String[] lines = currentText.split("\n");
    StringBuilder newText = new StringBuilder();
    for (String line : lines) {
        if (!line.trim().equals(authorStr.trim())) {
            newText.append(line).append("\n");
        }
    }
    this.jTextArea2.setText(newText.toString().trim());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      try {
        // Datos comunes
        String title = this.jTextField9.getText().trim();
        String isbn = this.jTextField11.getText().trim();
        String genre = (String) this.jComboBox2.getSelectedItem();
        String format = (String) this.jComboBox4.getSelectedItem();
        double value = Double.parseDouble(this.jTextField12.getText().trim());
        
        // Publisher
        String publisherStr = (String) this.jComboBox5.getSelectedItem();
        if (publisherStr == null || publisherStr.equals("Seleccione uno...")) {
            javax.swing.JOptionPane.showMessageDialog(this, 
        ...
        String publisherNit = publisherStr.split(" \\(")[1].replace(")", "");
        
        // Autores del TextArea
        String authorsText = this.jTextArea2.getText().trim();
        ...
        String[] authorsLines = authorsText.split("\n");
        ArrayList<Author> authors = new ArrayList<>();
        for (String line : authorsLines) {
            long authorId = Long.parseLong(line.split(" - ")[0]);
        ...
        // Determinar qué tipo de libro crear
        if (this.jRadioButton1.isSelected()) {
            // PrintedBook
            int pages = Integer.parseInt(this.jTextField14.getText().trim());
            int copies = Integer.parseInt(this.jTextField13.getText().trim());
            response = controller.crearPrintedBook(title, authors, isbn, genre, format, value, publisherNit, pages, copies);
            
        } else if (this.jRadioButton2.isSelected()) {
            // DigitalBook
            response = controller.crearDigitalBook(title, authors, isbn, genre, format, value, publisherNit);
            
        } else if (this.jRadioButton3.isSelected()) {
            // Audiobook
            int duration = Integer.parseInt(this.jTextField16.getText().trim());
            String narratorStr = (String) this.jComboBox6.getSelectedItem();
            if (narratorStr == null || narratorStr.equals("Seleccione uno...")) {
                javax.swing.JOptionPane.showMessageDialog(this, 
                    "Debe seleccionar un narrador", 
                    "Error", 
                    javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }
            long narratorId = Long.parseLong(narratorStr.split(" - ")[0]);
            response = controller.crearAudiobook(title, authors, isbn, genre, format, value, publisherNit, duration, narratorId);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        String standStr = (String) this.jComboBox7.getSelectedItem();
    
    if (standStr == null || standStr.equals("Seleccione uno...")) {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Debe seleccionar un stand", 
            "Error", 
            javax.swing.JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    // Validar duplicados
    String currentText = this.jTextArea3.getText();
    if (currentText.contains(standStr)) {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Este stand ya fue agregado", 
            "Error", 
            javax.swing.JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    if (currentText.isEmpty()) {
        this.jTextArea3.setText(standStr);
    } else {
        this.jTextArea3.setText(currentText + "\n" + standStr);
     }
    ...
    if (standStr == null || standStr.equals("Seleccione uno...")) {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Debe seleccionar un stand para eliminar", 
            "Error", 
            javax.swing.JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    if (!currentText.contains(standStr)) {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Este stand no está en la lista", 
            "Advertencia", 
            javax.swing.JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    StringBuilder newText = new StringBuilder();
    for (String line : lines) {
        if (!line.trim().equals(standStr.trim())) {
            newText.append(line).append("\n");
        }
    }
    this.jTextArea3.setText(newText.toString().trim());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
     String publisherStr = (String) this.jComboBox8.getSelectedItem();
    ...
    // Validar duplicados
    String currentText = this.jTextArea1.getText();
    if (currentText.contains(publisherStr)) {
        javax.swing.JOptionPane.showMessageDialog(this, 
            "Esta editorial ya fue agregada", 
            "Error", 
            javax.swing.JOptionPane.WARNING_MESSAGE);
        return;
    }
    ...
    // Agregar al TextArea
    if (currentText.isEmpty()) {
        this.jTextArea1.setText(publisherStr);
    } else {
        this.jTextArea1.setText(currentText + "\n" + publisherStr);
     }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        try {
        // Obtener stands del TextArea3
        String standIdsText = this.jTextArea3.getText().trim();
        if (standIdsText.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Debe agregar al menos un stand", 
                "Error", 
                javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        // Obtener publishers del TextArea1
        String publishersText = this.jTextArea1.getText().trim();
        if (publishersText.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, 
                "Debe agregar al menos una editorial", 
                "Error", 
                javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        String[] standIds = standIdsText.split("\n");
        String[] publishersData = publishersText.split("\n");
        
        StandComprasController controller = new StandComprasController();
        int exitosos = 0;
        int fallidos = 0;
        String errores = "";
        
        // Para cada stand, asignarlo a todas las editoriales
        for (String standIdStr : standIds) {
            long standId = Long.parseLong(standIdStr.trim());
            
            for (String publisherData : publishersData) {
                // Extraer NIT del formato "Nombre (NIT)"
                String publisherNit = publisherData.split("\\(")[1].replace(")", "").trim();
                
                // Comprar stand
                Response<Void> response = controller.comprarStand(standId, publisherNit);
                
                if (response.getStatusCode() == StatusCode.OK) {
                    exitosos++;
                } else if (response.getStatusCode() == StatusCode.ALREADY_EXISTS) {
                    exitosos++;
                } else {
                    fallidos++;
                    errores += response.getMessage() + "\n";
                }
            }
        }
        
        // Mostrar resultado
        String mensaje = "Compras exitosas: " + exitosos;
        if (fallidos > 0) {
            mensaje += "\nErrores: " + fallidos + "\n" + errores;
        }
        ...
        javax.swing.JOptionPane.showMessageDialog(this, 
            mensaje, 
            "Resultado", 
            fallidos > 0 ? javax.swing.JOptionPane.WARNING_MESSAGE : javax.swing.JOptionPane.INFORMATION_MESSAGE);
        
        // Limpiar TextAreas si todo exitoso
        if (fallidos == 0) {
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        // TODO add your handling code here:
      PublisherController controller = new PublisherController();
    Response<ArrayList<Publisher>> response = controller.obtenerTodos();
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        // TODO add your handling code here:
        PersonController controller = new PersonController();
    Response<ArrayList<Person>> response = controller.obtenerTodos();
    ...
    if (response.getStatusCode() == StatusCode.OK) {
        for (Person person : response.getData()) {
            ...
            if (person instanceof Author) {
                tipo = "Autor";
                nroLibros = ((Author) person).getBookQuantity();
            } else if (person instanceof Manager) {
                tipo = "Gerente";
                Manager manager = (Manager) person;
                if (manager.getPublisher() != null) {
                    editorial = manager.getPublisher().getName();
                }
            } else if (person instanceof Narrator) {
                tipo = "Narrador";
                nroLibros = ((Narrator) person).getBookQuantity();
            }
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
      ...
      StandController controller = new StandController();
    Response<ArrayList<Stand>> response = controller.obtenerTodos();
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        // TODO add your handling code here:
        String search = (String) this.jComboBox9.getSelectedItem();
    
    BookController controller = new BookController();
    Response<ArrayList<Book>> responseBooks = null;
    
    // Determinar qué método llamar según selección
    if (search.equals("Libros Impresos")) {
        Response<ArrayList<PrintedBook>> response = controller.obtenerPrintedBooks();
        responseBooks = new Response<>(response.getStatusCode(), response.getMessage(), new ArrayList<>(response.getData()));
    } else if (search.equals("Libros Digitales")) {
        Response<ArrayList<DigitalBook>> response = controller.obtenerDigitalBooks();
        responseBooks = new Response<>(response.getStatusCode(), response.getMessage(), new ArrayList<>(response.getData()));
    } else if (search.equals("Audiolibros")) {
        Response<ArrayList<Audiobook>> response = controller.obtenerAudiobooks();
        responseBooks = new Response<>(response.getStatusCode(), response.getMessage(), new ArrayList<>(response.getData()));
    } else { // "Todos los Libros"
        responseBooks = controller.obtenerTodos();
    }
    
    DefaultTableModel model = (DefaultTableModel) this.jTable4.getModel();
    model.setRowCount(0);
    
    if (responseBooks.getStatusCode() == StatusCode.OK) {
        for (Book book : responseBooks.getData()) {
            ...
            if (book instanceof PrintedBook) {
                ...
                model.addRow(new Object[]{
                    pb.getTitle(), authors, pb.getIsbn(), pb.getGenre(), pb.getFormat(),
                    pb.getValue(), pb.getPublisher().getName(), pb.getCopies(),
                    pb.getPages(), "-", "-", "-"
                });
            } else if (book instanceof DigitalBook) {
                DigitalBook db = (DigitalBook) book;
                model.addRow(new Object[]{
                    db.getTitle(), authors, db.getIsbn(), db.getGenre(), db.getFormat(),
                    db.getValue(), db.getPublisher().getName(), "-", "-",
                    db.hasHyperlink() ? db.getHyperlink() : "No", "-", "-"
                });
            } else if (book instanceof Audiobook) {
                Audiobook ab = (Audiobook) book;
                model.addRow(new Object[]{
                    ab.getTitle(), authors, ab.getIsbn(), ab.getGenre(), ab.getFormat(),
                    ab.getValue(), ab.getPublisher().getName(), "-", "-", "-",
                    ab.getNarrador().getFullname(), ab.getDuration()
                });
            }
        }
     }
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        // TODO add your handling code here:
       try {
        String authorStr = (String) this.jComboBox10.getSelectedItem();
        ...
        // Usar controlador de consultas
        ConsultasController controller = new ConsultasController();
        Response<ArrayList<Book>> response = controller.buscarLibrosPorAutor(authorId);
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        // TODO add your handling code here:
       try {
        String formato = (String) this.jComboBox11.getSelectedItem();
        
        if (formato == null || formato.equals("Seleccione uno...")) {
            javax.swing.JOptionPane.showMessageDialog(this, 
        ...
        // Usar controlador de consultas
        ConsultasController controller = new ConsultasController();
        Response<ArrayList<Book>> response = controller.buscarLibrosPorFormato(formato);
   ...
   try {
        // Usar controlador de consultas
        ConsultasController controller = new ConsultasController();
        Response<ArrayList<ConsultasController.AutorEstadistica>> response = controller.obtenerAutoresConMasLibrosEnEditoriales();
        
        DefaultTableModel model = (DefaultTableModel) this.jTable6.getModel();
        model.setRowCount(0);
        
        if (response.getStatusCode() == StatusCode.OK) {
            for (ConsultasController.AutorEstadistica estadistica : response.getData()) {
                model.addRow(new Object[]{
                    estadistica.autor.getId(),
                    estadistica.autor.getFullname(),
                    estadistica.numEditoriales + " editoriales, " + estadistica.totalLibros + " libros"
                });
            }
